...
const exec = async (argv) => {
    ...
    // Double check
    for (let i = 1; i < 3; i++) {
        logger_1.logger.warn('' + i + '/2 ATTENZIONE! Questa procedura configura un disco aggiuntivo NUOVO, ed esegue una FORMATTAZIONE del disco in questione. Non usare questa procedura per connettere un disco già popolato! Per connettere un disco popolato, vedi https://learn.microsoft.com/en-us/azure/virtual-machines/linux/attach-disk-portal?tabs=ubuntu#attach-an-existing-disk');
