...
async function command(session, answers) {
    ...
    logger_1.logger.log('Upload e avvio setup-redis.sh...');
    await (0, uploadShFile_1.uploadAndRunShFile)(session, path_1.default.join(__dirname, './setup-redis.sh'), '/tmp/setup-redis.sh', [answers.password]);
